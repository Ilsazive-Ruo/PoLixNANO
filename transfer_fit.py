...
scaler.fit(x)
joblib.dump(scaler, 'data7/scaler.joblib')
x = scaler.transform(x)

X_train, X_test, y_train, y_test = train_test_split(x, y, test_size=0.3, random_state=431)
...
df.to_csv('data7/transfer_fit_s.csv', index=False)
